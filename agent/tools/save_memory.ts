...
export default defineTool({
  ...
  inputSchema: z.object({
    reason: z.string().min(1).describe("Brief reason these facts are worth remembering"),
    updates: z.array(updateSchema).min(1).max(5).describe("Memory updates to save in one approved batch"),
  }),
